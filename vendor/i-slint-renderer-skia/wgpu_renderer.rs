...
impl SkiaWGPURenderer {
    ...
    pub fn render_to_texture(&self, texture: &wgpu::Texture) -> Result<(), PlatformError> {
        self.renderer
            .invoke_rendering_notifier_setup(&self.surface)?;
        ...
        let mut skia_surface = self
            .surface
            .backend
            .make_surface(gr_context, texture)
            .ok_or_else(|| {
...
impl RendererSealed for SkiaWGPURenderer {
    fn text_size(
        ...
        self.renderer
            .text_size(text_item, item_rc, max_width, text_wrap)
    }
    ...
    fn text_input_byte_offset_for_position(
        ...
        self.renderer
            .text_input_byte_offset_for_position(text_input, item_rc, pos)
    }
    ...
    fn text_input_cursor_rect_for_byte_offset(
        ...
        self.renderer
            .text_input_cursor_rect_for_byte_offset(text_input, item_rc, byte_offset)
    }
